...
_DIR = "flex_flash_attention/instantiations"
...
def flex_flash_sources(disabled_hdims=(), disable_backward=False,
    ...
    """
    srcs = ["flex_flash_attention/csrc/flex_flash_attention_api.cpp",
            ...
            "flex_flash_attention/csrc/mask_decomp_kernels.cu",
            "flex_flash_attention/csrc/mask_decomp_segment.cu",
            "flex_flash_attention/csrc/mask_decomp_classify.cu",
            "flex_flash_attention/csrc/mask_decomp_layout.cu"]
